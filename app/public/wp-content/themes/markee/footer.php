<footer class="site-footer">
  <div class="container">
    <div class="footer-grid">
      <div>
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="logo"><span class="logo-mark">M</span> <?php bloginfo( 'name' ); ?></a>
      ...
      <div class="footer-col">
        <h5>Giới thiệu</h5>
        <ul>
          <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>">Về Markee</a></li>
    ...
    <div class="footer-bottom">
      <span>© <?php echo date('Y'); ?> <?php bloginfo( 'name' ); ?>. Bản quyền thuộc về Markee Agency.</span>
